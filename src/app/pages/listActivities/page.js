...
import Popuptnv from "@/component/popup/popuptnv";
...
export default function listActivities() {
    ...
    return(
                    ...
                    {news.map((news) => (
                        <div key={news.id} className="group relative bg-[#D7E5BE] shadow-xl py-4 px-4 rounded-2xl ">
                            <div className="aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-md bg-gray-200 lg:aspect-none group-hover:opacity-75 lg:h-60">
                                <img
                                    src={news.images}
                                    className="h-full w-full object-cover object-center h-[240px] w-[374px]"
                                />
                            </div>
        ...
        <Footer/>
        <Popuptnv onClose={handleOnClose} visible={showPopuptnv}/>
        </Fragment>
